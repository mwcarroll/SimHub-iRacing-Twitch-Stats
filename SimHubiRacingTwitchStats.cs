...
using IRacingReader;
using SimHub.iRacing.Twitch.Stats.Config;
using SimHub.iRacing.Twitch.Stats.Config.SensorConfigs;
...
namespace SimHub.iRacing.Twitch.Stats
{
    ...
    [PluginDescription("iRacing Stats for Twitch")]
    [PluginName("iRacing Stats for Twitch")]
    ...
    public class SimHubIRacingTwitchStatsPlugin : IDataPlugin, IWPFSettingsV2
    {
        ...
        public SimHubIRacingTwitchStatsPluginUserSettings UserSettings { get; private set; }
        ...
        public Control GetWPFSettingsControl(PluginManager pluginManager)
        {
            ...
            {
                wpfSettingsControl = new SimHubIRacingTwitchStatsPluginUi(this);
            }
        ...
        public void Init(PluginManager pluginManager)
        {
            ...
            UserSettings = this.ReadCommonSettings("UserSettings", () => new SimHubIRacingTwitchStatsPluginUserSettings());
        ...
        internal void CreateMqttClient()
        {
            ...
            catch (MqttCommunicationException ex)
            {
                ...
                {
                    (GetWPFSettingsControl(PluginManager) as SimHubIRacingTwitchStatsPluginUi).UpdateLastError();
                });
            }
            catch (Exception ex)
            {
